...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   settings_linker_init_bonus.c                       :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: enena <enena@student.21-school.ru>         +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/28 11:37:29 by enena             #+#    #+#             */
/*   Updated: 2022/01/08 18:43:31 by enena            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_links_group_1(t_setting_link *links)
{
	...
	init_setting_link(&links[s_animation], "S", 5, &set_anime);
	init_setting_link(&links[floor_color], "F", 2, &set_color);
	init_setting_link(&links[ceil_color], "C", 2, &set_color);
	init_setting_link(&links[door_close], "D", 2, &set_texture);
	init_setting_link(&links[door_open], "d", 2, &set_texture);
}
