...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   wall_calculate_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: enena <enena@student.21-school.ru>         +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/09 07:49:25 by enena             #+#    #+#             */
/*   Updated: 2022/01/08 17:37:43 by enena            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "instruments_bonus.h"

static int	choose_texture(t_game_master *gm, t_ray *ray)
{
	if (ray->side == n_s)
	{
		if (ray->y > gm->pl->y)
...
static void	took_wall_texture(t_game_master *gm, t_ray *ray, t_wall *wall)
{
	...
	wall->y = (ray->wall_top - *(ray->horizon)
			+ wall->height / 2) * wall->step_y;
}
